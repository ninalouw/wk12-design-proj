        ...
        <div class="parallax pattern-image">
            ...
            <div class="container">
                <div class="content row">
                        <h1>Meet The Team</h1>
                        <p class="section-header-p">We are committed creatives who love doing what we do.
                        </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="team-image-div col-lg-3 col-sm-4 col-xs-6">
            <div class="team-overlay">
                <p class="text-muted">CEO and Marketing Director</p>
        ...
        <div class="team-image-div col-lg-3 col-sm-4 col-xs-6">
            <div class="team-overlay">
                <p class="text-muted">Director of Customer Success</p>
        ...
        <div class="team-image-div col-lg-3 col-sm-4 col-xs-6">
            <div class="team-overlay">
                <p class="text-muted">QA and UX Lead Designer</p>
